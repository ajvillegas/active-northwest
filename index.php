		...
		<main class="site-inner">
			<section class="hero-image">
				<div class="wrap">
					...
					<p class="subheading">Smaller Descriptive Subheading</p>
				</div>
			</section>
				...
				<div class="color-palette wrap">
						...
						<div class="colorgroup">
							<div class="color -primary">
								<div class="info">
									...
									<span class="value">HEX: #fb2740</span>
								</div>
							</div>
							...
							<div class="color -secondary">
								<div class="info">
									...
									<span class="value">HEX: #17191d</span>
								</div>
							</div>
							...
							<div class="color -tertiary">
								<div class="info">
									...
									<span class="value">HEX: #04d8bf</span>
								</div>
							</div>
							...
							<div class="color -background">
								<div class="info">
									...
									<span class="value">HEX: #ffffff</span>
								</div>
							</div>
						</div>
					</section>
					...
					<section class="section">
						...
						<div class="textgroup">
							<div class="color -primary">
								<p>
									<span class="background">Lorem ipsum dolor sit amet, consectetur.</span><br>
									<span class="secondary">Pellentesque interdum arcu eu velit consequat.</span>
								</p>
							</div>

							<div class="color -secondary">
								<p>
									<span class="background">Lorem ipsum dolor sit amet,</span>
									<span class="tertiary">consectetur</span><span class="background">.</span><br>
									<span class="primary">Pellentesque interdum arcu eu velit consequat.</span>
								</p>
							</div>
						</div>
						...
						<div class="textgroup">
							...
							<div class="color -background">
								<p>
									...
									<span class="tertiary">consectetur</span><span class="secondary">.</span><br>
									<span class="primary">Pellentesque interdum arcu eu velit consequat.</span>
								</p>
							</div>
						</div>
						...
						<div class="colorgroup">
							<div class="color -darkgray">
								<div class="info">
									...
									<span class="value">HEX: #272a2f</span>
								</div>
							</div>
							...
							<div class="color -mediumgray">
								<div class="info">
									...
									<span class="value">HEX: #474d57</span>
								</div>
							</div>
							...
							<div class="color -lightgray">
								<div class="info">
									...
									<span class="value">HEX: #d8d8d8</span>
								</div>
							</div>
							...
							<div class="color -verylightgray">
								<div class="info">
									...
									<span class="value">HEX: #f7f6f6</span>
								</div>
							</div>
						</div>
					</section>
						...
						<div class="colorgroup">
							<div class="color -alert">
								<div class="info">
									...
									<span class="value">HEX: #fff6bf</span>
								</div>
							</div>
							...
							<div class="color -error">
								<div class="info">
									...
									<span class="value">HEX: #fbe3e4</span>
								</div>
							</div>
							...
							<div class="color -notice">
								<div class="info">
									...
									<span class="value">HEX: #e5edf8</span>
								</div>
							</div>
							...
							<div class="color -success">
								<div class="info">
									...
									<span class="value">HEX: #e6efc2</span>
								</div>
							</div>
						</div>
					</section>
