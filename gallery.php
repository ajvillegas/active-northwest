...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Here you will find photos from previous Ace in the Hole Multisport weekend events.">

        <title>Photo Gallery | Ace in the Hole Multisport Event</title>
