    ...
    <body>
        ...
        <main class="site-inner">
            <section class="hero-image -volunteer">
                <div class="wrap">
                    <h1 class="heading">Become a Volunteer</h1>
                    <p class="subheading">Get Involved by Joining Our Team</p>
                </div>
            </section>
            ...
            <section id="content">
                <div class="wrap">
                    ...
                    <p><strong>Here is a list of the various volunteering roles available for you:</strong></p>

                    <ul class="default-ul">
                        <li><strong>Event Organization</strong> - Ensure that everyone is where they need to be at the correct time.</li>
                        <li><strong>Staging</strong> - Help all participants get ready on the starting line when it’s time to race.</li>
                        <li><strong>Chip Timing</strong> - Record the time for each participant after crossing the finish line.</li>
                    </ul>
                </div>
            </section>
